...
const nasceramEFaleceramNoMes = figurasHistoricas
  .filter(
    (figura) =>
      new Date(figura.dataNascimento).getMonth() ===
      new Date(figura.dataFalecimento).getMonth()
  )
  .map((figura) => `${figura.nome} ${figura.sobrenome}`);
console.log(nasceramEFaleceramNoMes);
