...
const ativistas = figurasHistoricas
  .filter((figura) => figura.profissao.toLowerCase().includes("ativista"))
  .map((figura) => figura.idade);

const mediaIdadesAtivistas =
  ativistas.reduce((a, b) => a + b, 0) / ativistas.length;
console.log(mediaIdadesAtivistas);
