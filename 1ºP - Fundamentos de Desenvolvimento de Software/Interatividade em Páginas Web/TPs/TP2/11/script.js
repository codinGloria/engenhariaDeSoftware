...
/* ******** Exercicio 08 ******** */
const primeiroItem = document.querySelector("ul li");
primeiroItem.remove();

const primeiroParagrafoRemover = document.getElementById("primeiro");
primeiroParagrafoRemover.remove();
...
/* ******** Exercicio 10 ******** */
const segundaImagem = document.querySelector("#galeria img:nth-child(2)");
const primeiroItemLista = document.querySelector("ul li");

alert(`Valor do primeiro item da lista: ${primeiroItemLista.textContent}`);

/* ******** Exercicio 11 ******** */
const primeiraImagem = document.querySelector("#galeria img");
alert(`O atributo src da primeira imagem é: ${primeiraImagem.src}`);
